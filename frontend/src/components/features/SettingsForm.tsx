...
export const SettingsForm: React.FC<SettingsFormProps> = ({ onSubmit, isLoading = false }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 rounded-lg border border-slate-700 bg-slate-800 p-6">
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <div>
          ...
          <select
            ...
            className="mt-1 block w-full rounded-md border-slate-600 bg-slate-700 text-white py-2 px-3 shadow-sm focus:border-blue-500 focus:outline-none border"
          >
        ...
        {/* Model Movement */}
        <div>
          <label className="block text-sm font-medium text-slate-300">Model Movement</label>
          <select
        ...
        {/* Audio Style */}
        <div>
          <label className="block text-sm font-medium text-slate-300">Audio Style</label>
          <select
      ...
      {/* Script Text */}
      <div>
        <label className="block text-sm font-medium text-slate-300">Script (Optional)</label>
        <textarea
          ...
          rows={4}
          className="mt-1 block w-full rounded-md border border-slate-600 bg-slate-700 text-white py-2 px-3 shadow-sm focus:border-blue-500 focus:outline-none"
        />
        <p className="mt-1 text-xs text-slate-400">Used for text-to-speech narration</p>
      </div>
